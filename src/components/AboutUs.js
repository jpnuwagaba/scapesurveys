        ...
        <div className='aboutUs container'>
            <div className="aboutUs-left">
                ...
                <div className="aboutUs-left-text">
                    <h1>AboutUs</h1>
                    <p>
                        Scapes and Surveys is a survey firm based in Kampala Uganda with competencies in Geomatics and Land
                        Management. Established in 2012, and is now providing precise and reliable solutions pertaining to
